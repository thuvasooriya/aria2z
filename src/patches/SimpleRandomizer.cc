...
#if defined(__APPLE__) && defined(HAVE_APPLETLS) && __has_include(<Security/SecRandom.h>)
#  include <Security/SecRandom.h>
#  define ARIA2_HAVE_SECRANDOM_H 1
#endif
...
void SimpleRandomizer::getRandomBytes(unsigned char* buf, size_t len)
{
...
#elif defined(ARIA2_HAVE_SECRANDOM_H)
  ...
  for (size_t i = 0; i < len; ++i) {
    buf[i] = static_cast<unsigned char>((*this)() & 0xff);
  }
#endif // !__MINGW32__ && !ARIA2_HAVE_SECRANDOM_H && !HAVE_OPENSSL && !HAVE_LIBGNUTLS
}
